...
export default function HeadlineList({newsList}) {
  ...
  renderItem={({item})=>(
    <View>
<TouchableOpacity style={{marginTop:10,display:'flex', flexDirection:'row'}}>
...
<View style={{height:5,backgroundColor:Colors.LIGHT_PRIMARY,marginTop:10,borderRadius:50}}></View>
</View>
